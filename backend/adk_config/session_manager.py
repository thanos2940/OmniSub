"""
Session Manager for Omnisub Projects

Maps Omnisub projects to ADK sessions for state persistence.
...
class OmnisubSessionManager:
    """
    Manages ADK sessions for Omnisub projects.
    ...
    def _session_id(self, project_name: str) -> str:
        ...
        return f"omnisub_project_{project_name}"
